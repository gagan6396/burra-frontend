...
const rooms = [
  {
    ...
    description:
      "Our spacious bungalow in Mussoorie offers a perfect balance of comfort and understated luxury for families or groups seeking a peaceful mountain escape. Designed with elegance and warmth, this private retreat features three beautifully appointed bedrooms with heated blankets, along with two eastern- and western-facing patios that capture stunning panoramic views. Ideal as a premium villa stay in Mussoorie, the property blends generous living spaces, abundant natural light, and modern amenities to ensure a comfortable and memorable experience. Every detail has been thoughtfully curated to create a relaxing environment in every season. Whether you’re looking for a cozy homestay in Mussoorie or a luxury hillside getaway, this property promises serene mornings with a cup of tea on the patio and tranquil evenings under the open sky. With scenic surroundings and refined interiors, it offers the charm of a private mountain retreat with the comfort of a well-appointed home.",
    features: [
  ...
  },
  {
    title: "Annexe",
    description:
      "Experience authentic luxury in our annexe, thoughtfully designed to blend natural charm with refined comfort. Perfect for guests seeking a peaceful homestay in Mussoorie, this private retreat offers warmth, privacy, and a true connection to the hills. The annexe features two beautifully crafted bedrooms with heated blankets, ensuring a cozy stay even during cooler mountain nights. Designed with the elegance of a boutique villa stay, the space combines comfort with understated sophistication. Step out onto the private gallery to take in panoramic forest views, where the sights and sounds of nature create a deeply calming atmosphere. With its pinewood interiors, warm textures, and carefully curated details, this retreat reflects the charm of a hillside bungalow experience while offering modern comforts for a relaxing mountain escape.",
    features: [
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-black max-w-3xl mx-auto leading-relaxed">
             Experience unparalleled comfort and elegance at Burra Bungalow, a charming homestay and private villa in Mussoorie, where every detail is thoughtfully crafted for your perfect mountain stay.
            </p>
          </div>
